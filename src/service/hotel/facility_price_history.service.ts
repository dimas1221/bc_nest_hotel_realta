...
export class FacilityPriceHistoryService {
    constructor(@InjectRepository(FacilityPriceHistory)
    ...
    async createFacilitiPriceHisty(data: FacilityPriceHistory):Promise<FacilityPriceHistory>{
        return await this.fph.save(
            this.fph.create(data)
        )
    }
